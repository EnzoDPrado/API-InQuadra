...
var Login=function(){if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(9442)/* ["default"] */ .Z);}return (__webpack_require__(73347)/* ["default"] */ .Z);}();var FORMS={'forgot-password':{Component:components_ForgotPassword,endPoint:'forgot-password',fieldsToDisable:[],fieldsToOmit:[],schema:yup_es/* object */.Ry().shape({email:yup_es/* string */.Z_().email(helper_plugin_esm/* translatedErrors */.I0.email).required(helper_plugin_esm/* translatedErrors */.I0.required)}),inputsPrefix:''},'forgot-password-success':{Component:components_ForgotPasswordSuccess,endPoint:'',fieldsToDisable:[],fieldsToOmit:[],schema:null,inputsPrefix:''},login:{Component:Login,endPoint:'login',fieldsToDisable:[],fieldsToOmit:['rememberMe'],schema:yup_es/* object */.Ry().shape({email:yup_es/* string */.Z_().email(helper_plugin_esm/* translatedErrors */.I0.email).required(helper_plugin_esm/* translatedErrors */.I0.required),password:yup_es/* string */.Z_().required(helper_plugin_esm/* translatedErrors */.I0.required),rememberMe:yup_es/* bool */.Xg().nullable()}),inputsPrefix:''},oops:{Component:components_Oops,endPoint:null,fieldsToDisable:[],fieldsToOmit:[],schema:null,inputsPrefix:''},register:{Component:components_Register,endPoint:'register',fieldsToDisable:['email'],fieldsToOmit:['userInfo.confirmPassword','userInfo.news','userInfo.email'],schema:yup_es/* object */.Ry().shape({firstname:yup_es/* string */.Z_().trim().required(helper_plugin_esm/* translatedErrors */.I0.required),lastname:yup_es/* string */.Z_(),password:yup_es/* string */.Z_().min(8,helper_plugin_esm/* translatedErrors */.I0.minLength).matches(/[a-z]/,'components.Input.error.contain.lowercase').matches(/[A-Z]/,'components.Input.error.contain.uppercase').matches(/\d/,'components.Input.error.contain.number').required(helper_plugin_esm/* translatedErrors */.I0.required),confirmPassword:yup_es/* string */.Z_().oneOf([yup_es/* ref */.iH('password'),null],'components.Input.error.password.noMatch').required(helper_plugin_esm/* translatedErrors */.I0.required),registrationToken:yup_es/* string */.Z_().required(helper_plugin_esm/* translatedErrors */.I0.required)}),inputsPrefix:'userInfo.'},'register-admin':{Component:components_Register,endPoint:'register-admin',noSignin:true,fieldsToDisable:[],fieldsToOmit:['confirmPassword','news'],schema:yup_es/* object */.Ry().shape({firstname:yup_es/* string */.Z_().trim().required(helper_plugin_esm/* translatedErrors */.I0.required),lastname:yup_es/* string */.Z_(),password:yup_es/* string */.Z_().min(8,helper_plugin_esm/* translatedErrors */.I0.minLength).matches(/[a-z]/,'components.Input.error.contain.lowercase').matches(/[A-Z]/,'components.Input.error.contain.uppercase').matches(/\d/,'components.Input.error.contain.number').required(helper_plugin_esm/* translatedErrors */.I0.required),email:yup_es/* string */.Z_().email(helper_plugin_esm/* translatedErrors */.I0.email).strict().lowercase(helper_plugin_esm/* translatedErrors */.I0.lowercase).required(helper_plugin_esm/* translatedErrors */.I0.required),confirmPassword:yup_es/* string */.Z_().oneOf([yup_es/* ref */.iH('password'),null],'components.Input.error.password.noMatch').required(helper_plugin_esm/* translatedErrors */.I0.required)}),inputsPrefix:''},'reset-password':{Component:ResetPassword,endPoint:'reset-password',fieldsToDisable:[],fieldsToOmit:['confirmPassword'],schema:yup_es/* object */.Ry().shape({password:yup_es/* string */.Z_().min(8,helper_plugin_esm/* translatedErrors */.I0.minLength).matches(/[a-z]/,'components.Input.error.contain.lowercase').matches(/[A-Z]/,'components.Input.error.contain.uppercase').matches(/\d/,'components.Input.error.contain.number').required(helper_plugin_esm/* translatedErrors */.I0.required),confirmPassword:yup_es/* string */.Z_().oneOf([yup_es/* ref */.iH('password'),null],'components.Input.error.password.noMatch').required(helper_plugin_esm/* translatedErrors */.I0.required)})}};
...
const AuthPage = ({ hasAdmin, setHasAdmin }) => {
  ...
  const forms = (0,useEnterprise/* useEnterprise */.c)(
    FORMS,
    async () => (await __webpack_require__.e(/* import() */ 3105).then(__webpack_require__.bind(__webpack_require__, 83105))).FORMS,
    {
  ...
  const { Component, endPoint, fieldsToDisable, fieldsToOmit, inputsPrefix, schema, ...rest } = forms?.[authType] ?? {};
  (0,react.useEffect)(() => {
    return () => {
...
var fp_esm = __webpack_require__(6483);
...
function App() {
  const adminPermissions = (0,useEnterprise/* useEnterprise */.c)(ADMIN_PERMISSIONS_CE, async () => (await __webpack_require__.e(/* import() */ 7797).then(__webpack_require__.bind(__webpack_require__, 77797))).ADMIN_PERMISSIONS_EE, {
...
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(35650);
...
/* harmony import */ var _reducer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(29714);
...
/* harmony export */   Z: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(88376);
...
/* harmony import */ var _admin_src_pages_App_selectors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(99369);
...
const useLicenseLimits = () => {
  ...
  const rbac = (0,_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_0__/* .useRBAC */ .ss)(permissions.settings.users);
  const {
